...
import json
from graphene import ObjectType,String,List, Int,Schema,Field,Mutation
...
class Query(ObjectType):
    ...
    estudiante_por_carrera=Field(List(Estudiante),carrera=String())
...
estudiantes =[ 
    Estudiante(id=1, nombre='Pedro', apellido='Garcia' , carrera='Ingenieria de Sistemas'),
    Estudiante(id=2, nombre='Jose', apellido='Lopez' , carrera='Arquitectura'),
    Estudiante(id=3, nombre='Manuel', apellido='Lopez' , carrera='Arquitectura'),
]
